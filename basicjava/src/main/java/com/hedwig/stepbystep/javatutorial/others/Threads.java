package com.hedwig.stepbystep.javatutorial.others;
	...
	public static class WrapExceptionRunnable implements Runnable {
		...
		public void run() {
			try {
				...
				// catch any com.auto.exception, because the scheduled thread will break if the com.auto.exception thrown outside.
