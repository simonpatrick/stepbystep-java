 ...
 * {@link org.dbunit.database.DatabaseDataSourceConnection} using the specified {@link #setDataSource dataSource}. Additional configuration
...
public class DatabaseDataSourceConnectionFactoryBean implements FactoryBean<DatabaseDataSourceConnection> {
	...
	/**
	 * Set the data source that will be used for the {@link org.dbunit.database.DatabaseDataSourceConnection}. This value must be set before
	 ...
	 * {@link org.dbunit.database.DatabaseDataSourceConnection}
	 *
	...
	/**
	 * Determines if the {@link org.dbunit.database.IDatabaseConnection} created by this bean should be aware of Spring
	...
	/**
	 * Convenience method that can be used to construct a transaction aware {@link org.dbunit.database.IDatabaseConnection} from a
	 * {@link javax.sql.DataSource}.
	 * @param dataSource The data source
	 * @return A {@link org.dbunit.database.IDatabaseConnection}
	 */
