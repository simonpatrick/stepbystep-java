...
package com.hedwig.stepbystep.javatutorial.dbtest.dataset;
 ...
 * @see #createDataSet(org.springframework.core.io.Resource)
 */
public abstract class AbstractDataSetLoader implements DataSetLoader {

	/**
	 * Loads a {@link org.dbunit.dataset.IDataSet dataset} from {@link org.springframework.core.io.Resource}s obtained from the specified <tt>location</tt>. Each
	 * <tt>location</tt> can be mapped to a number of potential {@link #getResourceLocations resources}, the first
	 * resource that {@link org.springframework.core.io.Resource#exists() exists} will be used. {@link org.springframework.core.io.Resource}s are loaded using the
	 * {@link org.springframework.core.io.ResourceLoader} returned from {@link #getResourceLoader}.
	 * <p>
	...
	/**
	 * Gets the {@link org.springframework.core.io.ResourceLoader} that will be used to load the dataset {@link org.springframework.core.io.Resource}s.
	...
	/**
	 * Factory method used to create the {@link org.dbunit.dataset.IDataSet dataset}
