...
import com.hedwig.stepbystep.javatutorial.dbtest.annotation.DbUnitConfiguration;
import com.hedwig.stepbystep.javatutorial.dbtest.bean.DatabaseDataSourceConnectionFactoryBean;
 ...
 * <tt>ApplicationContext</tt> associated with the test. This bean can contain either a {@link org.dbunit.database.IDatabaseConnection} or a
 * {@link javax.sql.DataSource} . A custom bean name can also be specified using the
